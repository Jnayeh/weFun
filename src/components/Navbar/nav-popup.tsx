...
export default function NavPopup() {
  return (
    <div className="fixed top-3 right-4 text-right nav-popup">
        ...
        {({ open }) => (
          <>
            <Menu.Button
              className={
                open
                  ? 'menu-button rounded-xl right-0 dark:bg-gray-200'
                  : 'menu-button rounded-xl right-0 dark:bg-gray-700 bg-white'
              }
                ...
                <div className="px-1 py-1">
                  <Menu.Item>
                    {({ active }) => (
                      ...
                      >
                        {active ? (
                          <DeleteActiveIcon className="mr-2 h-5 w-5 text-gray-400" aria-hidden="true" />
                        ) : (
                          <DeleteInactiveIcon className="mr-2 h-5 w-5 text-gray-400" aria-hidden="true" />
                        )}
                        Delete
                      </button>
                    )}
